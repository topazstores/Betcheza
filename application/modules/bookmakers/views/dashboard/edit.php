	...
	<div class="box box-widget">
		...
		<div class="box-body">
			<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
				...
				<?php echo form_label(lang('bookmakers_current_logo') , 'logo', array('class' => 'col-md-2 control-label') ); ?>
					<div class="col-sm-4">
						 <img src="<?php echo base_url();?>uploads/bookmakers/<?php echo set_value('logo', isset($bookmakers->logo) ? $bookmakers->logo : ''); ?>" style="height:30px;"/>
						<input id="current_logo" type="hidden" name="current_logo" value="<?php echo set_value('logo', isset($bookmakers->logo) ? $bookmakers->logo : ''); ?>"/>				  
					</div>
				</div>
				...
				<?php if($bookmakers->banner):?>
				<div class="form-group">
				<?php echo form_label(lang('bookmakers_current_banner') , 'banner', array('class' => 'col-md-2 control-label') ); ?>
					<div class="col-sm-4">
						 <img src="<?php echo base_url();?>uploads/bookmakers/<?php echo set_value('banner', isset($bookmakers->banner) ? $bookmakers->banner : ''); ?>" style="height:30px;"/>
						<input id="current_banner" type="hidden" name="current_logo" value="<?php echo set_value('banner', isset($bookmakers->banner) ? $bookmakers->banner : ''); ?>"/>				  
					</div>
				</div>
				<?php endif;?>
